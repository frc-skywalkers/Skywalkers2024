...
public class AlignTag extends Command {
  ...
  private final PIDController xcontroller =
      new PIDController(LimelightConstants.kPx, LimelightConstants.kIx, LimelightConstants.kDx);

  private final PIDController ycontroller =
      new PIDController(LimelightConstants.kPy, LimelightConstants.kIy, LimelightConstants.kDy);
  private final PIDController rcontroller =
      new PIDController(LimelightConstants.kPr, LimelightConstants.kIr, LimelightConstants.kDr);
  ...
  public void execute() {
    ...
    xspeed =
        -1
            * MathUtil.clamp(
                (xcontroller.calculate(currentXDist, targetXDist)),
                -LimelightConstants.xclamp,
                LimelightConstants.xclamp);
    yspeed =
        -1
            * MathUtil.clamp(
                (ycontroller.calculate(
                    currentYDist, targetYDist - LimelightConstants.limelightOffsetCenter)),
                -LimelightConstants.yclamp,
                LimelightConstants.yclamp);
    rspeed =
        -0.5
            * MathUtil.clamp(
                (rcontroller.calculate(currentR, targetR)),
                -LimelightConstants.rclamp,
                LimelightConstants.rclamp);
    ...
    swerveSubsystem.runVelocity(new ChassisSpeeds(xspeed, yspeed, rspeed)); // Make rspeed 0
